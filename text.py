greet = "Привет, {name}, я бот, который подберет идеальный подарок твоему другу / подруге / маме / сыну ..."
menu = "📍 Главное меню"
...
text_watermark = '\n_______________________________________\nСоздано при помощи @oddforce'
img_watermark = "Создано при помощи @oddforce"
